...
class ColorRange:
    ...
    def __init__(self):
        ...
        self.ranges = {
            ...
            'blue': [
                (np.array([53, 0, 233]), np.array([117, 255, 255]))
            ]
        }
...
class BallDetector:
    ...
    def read_video_frames(self):
        ...
        while True:
            ...
            blue_mask = self.color_range.get_masks(hsv, 'blue')
            # 形态学处理
            ...
            if red_pixels > 9000:
                ...
                color = (0, 0, 255)  # 红色
            elif purple_pixels > 9000:
                text = "purple ball detected"
                color = (255, 0, 255)  # 紫色
            elif blue_pixels > 11000:
                text = "blue ball detected"
                color = (255, 0, 0)  # 蓝色
            else:
                text = "no ball"
...
if __name__ == "__main__":
    video_path = 'res/output1.avi'  # 替换为你的AVI视频路径
